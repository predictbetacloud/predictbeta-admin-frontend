...
const SeasonLeaderboard = () => {
	...
	return (
		<DashboardLayout title="Leaderboard">
			<section className="predictbeta-header bg-white w-full px-4 md:px-8 flex lg:items-between lg:justify-between flex-col-reverse lg:flex-row gap-4 lg:gap-0">
				<TabNav
					tabs={[
